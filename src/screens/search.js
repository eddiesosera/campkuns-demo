  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", padding: "20px", margin: "0 auto", width: "fit-content" }}>
        <div novalidate="novalidate" onsubmit={e => e.preventDefault()} className="searchbox sbx-custom" style={{}}>
          <div role="search" className="sbx-custom__wrapper">
            <input
              type="search"
              onFocus={e => setInsertSearch(e.target.value)}
              onChange={e => setSearchVal(e.target.value)}
              name="search"
              placeholder="Search more art"
              autocomplete="off"
              required="required"
        ...
        <div
          style={{ color: "#ffe7d9", marginLeft: "20px", fontFamily: "Hanken Grotesk", fontWeight: "500" }}
      ...
      <div className="searchResults" style={{ width: "100%", margin: "auto", height: "200px" }}>
        ...
        <div
          style={{ width: "fit-content", margin: "0 auto", display: "flex", color: "#ffe7d9", fontFamily: "Hanken Grotesk" }}
        >
