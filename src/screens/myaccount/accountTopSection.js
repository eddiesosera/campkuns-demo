...
function AccountTopSection() {
    ...
    return (
        <div className='userAccNav-wrap'>
            <div className='userAccTop-navInfo' style={{ display: 'flex', height: '60px', width: '100vw', maxWidth: '470px', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(30, 30, 30, 0.98)', backdropFilter: 'blur(6px)', position: 'fixed', top: '0', padding: '0 20px' }}>
                ...
                <div className='userAcc' style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{
                        ...
                        WebkitTextFillColor: 'transparent', backgroundClip: 'text', fontFamily: 'Montserrat', fontSize: '16px', fontWeight: '600'
                    }}>@katemoss</div>
