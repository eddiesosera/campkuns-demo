...
export const Explore = () => {
    ...
    const CategoryOptions = {
        display: 'flex', flexWrap: 'nowrap', padding: '0 15px', overflowX: 'scroll',
        justifyContent: 'flex-start', transition: 'all 0.2s cubic-bezier(0.5, 0.55, 0.70, 0.35)'
    }

    const [filters, setFilters] = useState([{ label: 'All', value: 'All' }, { label: 'eddie', value: 'eddie' }, { label: 'yay_abe', value: 'yay_abe' },
    ...
    useEffect(() => {
        axios
            ...
            .then((result) => {
                ...
                setFilters([{ label: 'All', value: 'All' }, { label: xplrProductsName[1], value: xplrProductsName[1] }, { label: xplrProductsName[3], value: xplrProductsName[3] }, { label: xplrProductsName[8], value: xplrProductsName[8] }, { label: xplrProductsName[15], value: xplrProductsName[15] }])
    ...
    return (
        <div>
            ...
            <div>
                <div style={{ marginBottom: '20px', marginTop: '20px', marginLeft: '20px', fontSize: '24px', fontWeight: '600', color: '#ffe7d9', fontFamily: 'Hanken Grotesk' }}>Explore Artists & Galleries</div>
                    ...
                    {xplrProducts.map((image, i) => (
                        ...
                        <div style={{}}>
                            <img
                                ...
                                key={i}
                                src={image}
                                style={{ width: "100%", display: "flex", borderRadius: '12px' }}
                            />
                            <div style={{ display: 'flex', marginTop: '10px', marginBottom: '15px', marginLeft: '10px' }}>
                                <img style={{ width: '20px', height: '20px', borderRadius: '50%', objectFit: 'cover', marginRight: '5px' }} src={image} alt='i' />
                                <div style={{ color: 'white', fontFamily: 'Hanken Grotesk', fontSize: '14px' }}>{xplrProductsName[nmIndx++]}</div>
                            </div>
            ...
            {/* Link to Explore */}
            <NavLink to="/">
                <div style={{ position: 'fixed', zIndex: '100', height: 'fit-content', width: 'fit-content', padding: '10px 15px', color: '#ed6d22', background: '#151515', bottom: '0', right: '0', marginRight: '20px', marginBottom: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center', borderRadius: '12px' }}>
                    <i style={{ color: '#ed6d22', fontSize: '24px' }} class="ri-home-4-fill"></i> <div style={{ marginLeft: '5px', fontSize: '16px', fontFamily: 'Hanken Grotesk' }}>Home</div>
                </div>
            </NavLink>
